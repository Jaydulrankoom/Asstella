...
const initialRoles: Role[] = [
  {
    ...
    name: "Super Admin",
    description:
      "Global root access. Can modify system infrastructure and global security policies.",
    usersCount: 1,
    permissions: ["all"],
  },
  {
    ...
    name: "Company Admin",
    description:
      "Full operational control over assets, users, and procurement within the organization.",
    usersCount: 2,
    permissions: [
      "users.manage",
      "assets.full",
  ...
  },
  {
    ...
    name: "Employee",
    description:
      "Standard access for viewing assets and submitting maintenance or purchase requests.",
    usersCount: 25,
    permissions: ["assets.view", "maintenance.request", "procurement.request"],
  },
  {
    id: "4",
    name: "Asset Manager",
    description:
      "Specialized access for lifecycle management, auditing, and maintenance coordination.",
    usersCount: 5,
    permissions: [
      "assets.view",
      "assets.edit",
  ...
  },
  {
    ...
    description:
      "Handles vendor relations, purchase requests, and supply chain logistics.",
    usersCount: 3,
    permissions: ["procurement.create", "vendors.manage"],
  },
];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-slate-500 font-bold uppercase text-[10px] tracking-widest mt-1">
            Configure global ERP parameters and governance
          </p>
        </div>
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          <div className="hidden lg:block bg-brand/5 border border-brand/10 rounded-3xl p-6">
            ...
            <p className="text-xs text-slate-500 leading-relaxed italic">
              All changes made to system settings are recorded in the global
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 text-center sm:text-left">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1 max-w-sm">
                      Define how your organization appears in reports and system
                      white-labelling.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="bg-card-bg border border-border-dim rounded-2xl sm:rounded-[3rem] p-6 sm:p-10 shadow-2xl">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-8 text-center sm:text-left">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-1">
                        Manage branches, departments, and cross-functional
                        teams.
                      </p>
                    </div>
                  ...
                  <div className="space-y-6 text-sm">
                    ...
                    {[
                      {
                        name: "Global HQ (New York)",
                        depts: ["Executive Board", "Operations", "Finance"],
                      },
                      {
                        name: "EMEA Branch (London)",
                        depts: ["Logistics", "Operations", "Maintenance"],
                      },
                      {
                        name: "APAC Hub (Singapore)",
                        depts: ["IT Support", "Procurement"],
                      },
                    ].map((branch, i) => (
                      <div
                        key={i}
                        className="border border-border-dim rounded-2xl overflow-hidden group"
                      >
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-[10px] text-slate-500 font-bold uppercase">
                                {branch.depts.length} Departments
                              </p>
                            </div>
                          </div>
                          <div className="flex items-center gap-2">
                            <button className="p-2 sm:p-3 bg-white dark:bg-white/5 border border-border-dim rounded-xl hover:text-brand transition-all">
                              <Edit3 className="w-4 h-4" />
                            </button>
                            <button className="p-2 sm:p-3 bg-white dark:bg-white/5 border border-border-dim rounded-xl hover:text-rose-500 transition-all">
                        ...
                        <div className="p-4 sm:p-6 flex flex-wrap gap-2">
                          {branch.depts.map((dept) => (
                            <div
                              key={dept}
                              className="flex items-center gap-2 px-3 py-1.5 bg-slate-100 dark:bg-slate-900 border border-border-dim rounded-lg text-[10px] font-black uppercase text-slate-600 dark:text-slate-400"
                            >
                              {dept}
                ...
                <div className="bg-card-bg border border-border-dim rounded-2xl sm:rounded-[3rem] p-6 sm:p-10 shadow-2xl">
                  ...
                  <div className="overflow-hidden border border-border-dim rounded-2xl divide-y divide-border-dim">
                    {roles.map((role) => (
                      <div
                        key={role.id}
                        className="p-4 sm:p-6 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-4 group"
                      >
                        <div className="flex items-start sm:items-center gap-4">
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              <span className="px-1.5 py-0.5 bg-brand/10 text-brand text-[8px] font-black rounded-md uppercase">
                        ...
                        <div className="flex items-center justify-end gap-2 sm:opacity-0 group-hover:opacity-100 transition-opacity">
                          <button className="flex-1 sm:flex-none p-2 md:p-2.5 bg-white dark:bg-white/5 border border-border-dim rounded-lg sm:rounded-xl hover:text-brand transition-all flex items-center justify-center">
                            <Edit3 className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                          </button>
                          <button className="flex-1 sm:flex-none p-2 md:p-2.5 bg-white dark:bg-white/5 border border-border-dim rounded-lg sm:rounded-xl hover:text-rose-500 transition-all flex items-center justify-center">
                ...
                <div className="bg-card-bg border border-border-dim rounded-2xl sm:rounded-[3rem] p-6 sm:p-10 shadow-2xl overflow-x-auto">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-8 text-center sm:text-left">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-1">
                        Cross-functional access rights overview.
                      </p>
                    </div>
                  </div>
                    ...
                    <table className="w-full text-left border-collapse bg-app-bg rounded-xl overflow-hidden shadow-inner">
                      ...
                      <tbody className="divide-y divide-border-dim text-sm text-slate-600 dark:text-slate-400">
                        {[
                          ...
                          {
                            mod: "QR/Barcode Generation",
                            perms: [true, true, true, false],
                          },
                          {
                            mod: "Asset Request & Checkout",
                            perms: [true, true, true, true],
                          },
                          {
                            mod: "System Configurations",
                          ...
                          >
                            <td className="p-4 font-bold text-[11px] uppercase tracking-wide text-slate-700 dark:text-slate-300">
                              {row.mod}
                            </td>
                            {row.perms.map((p, pIdx) => (
                              <td key={pIdx} className="p-4 text-center">
                                {p ? (
                                  ...
                                  <span className="inline-block w-2.5 h-2.5 rounded-full bg-rose-500/20"></span>
                                )}
                              </td>
                            ))}
                          </tr>
                ...
                <div className="bg-amber-50 dark:bg-amber-500/5 border border-amber-200 dark:border-amber-500/20 p-6 rounded-2xl sm:rounded-3xl flex flex-col sm:flex-row gap-4">
                  ...
                  <div className="text-center sm:text-left">
                    ...
                    <p className="text-[11px] text-amber-700 dark:text-amber-300/70 leading-relaxed">
                      Enable Multi-Factor Authentication for all high-privilege
                      roles to prevent unauthorized perimeter breaches.
                    </p>
                    <button className="mt-3 text-[10px] font-black text-amber-600 dark:text-amber-400 uppercase tracking-widest hover:underline">
                      Harden Policies Now
                    </button>
                  </div>
                </div>
            ...
            {activeTab === "notifications" && (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    Configure automated triggers and dispatch protocols.
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  <ToggleSetting
                    ...
                    onChange={(v) =>
                      setNotifSettings({ ...notifSettings, emailAlerts: v })
                    }
                  />
                  <ToggleSetting
                    title="Push Protocol"
                  ...
                  <ToggleSetting
                    ...
                    onChange={(v) =>
                      setNotifSettings({ ...notifSettings, smsAlerts: v })
                    }
                  />
                </div>

                <div className="pt-8 sm:pt-10 border-t border-border-dim">
                  <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-6 px-1 text-center sm:text-left">
                    Trigger Thresholds
                  </h4>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
                    <SettingsSelect
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div className="text-center sm:text-left">
                    ...
                    <p className="text-xs text-slate-500 mt-1">
                      Configure asset storage and database redundancy.
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 gap-6">
                  <div className="p-6 sm:p-8 bg-slate-50 dark:bg-black/20 border border-border-dim rounded-2xl sm:rounded-3xl flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left">
                    ...
                    <div className="flex-1 w-full">
                      <h4 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-tight">
                        Main Storage (Amazon S3)
                      </h4>
                      <p className="text-[10px] sm:text-xs text-slate-500 mt-0.5">
                        Bucket: asset-erp-prod • 42 / 500 GB
                      </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="p-6 border border-border-dim rounded-2xl space-y-4">
                      ...
                      <button className="w-full py-3 bg-slate-100 dark:bg-white/5 text-[9px] font-black uppercase tracking-widest rounded-xl hover:bg-brand hover:text-white transition-all">
                        Manual Backup
                      </button>
                    </div>
                    <div className="p-6 border border-border-dim rounded-2xl space-y-4">
            ...
            {activeTab === "security" && (
              ...
              >
                <div className="text-center sm:text-left">
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    Manage network access and authentication policies.
                  </p>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                      ...
                      <div className="p-6 bg-slate-50 dark:bg-white/5 rounded-2xl sm:rounded-3xl border border-border-dim">
                        <p className="text-[11px] text-slate-600 dark:text-slate-400 leading-relaxed mb-4 text-center sm:text-left">
                          Require biometric or TOTP authentication for all
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="p-6 bg-slate-50 dark:bg-white/5 rounded-2xl sm:rounded-3xl border border-border-dim">
                        <p className="text-[11px] text-slate-600 dark:text-slate-400 leading-relaxed mb-4 text-center sm:text-left">
                          Restrict access to office-based internal networks
                          only.
                        </p>
                        <button className="w-full py-3 border border-dashed border-slate-300 dark:border-white/10 rounded-xl text-[9px] font-black uppercase tracking-widest text-slate-400 hover:text-brand hover:border-brand transition-all">
                          Add Allowed IP
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="p-4 bg-app-bg border border-border-dim rounded-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                          <div className="p-2 bg-slate-100 dark:bg-white/5 rounded-lg text-slate-500 flex-shrink-0">
                          ...
                          <div className="overflow-hidden">
                            ...
                            <p className="text-[9px] text-slate-500 font-mono truncate max-w-[200px] sm:max-w-none">
                              erp_pk_live_********************a901
                            </p>
                          </div>
                        </div>
                        <span className="text-[9px] font-black text-slate-400 uppercase self-end sm:self-auto">
                          Created 2m ago
                        </span>
                      </div>
                    </div>
    ...
    <div className="flex items-center justify-between p-1">
      ...
      <button
        ...
        className={cn(
          ...
          active
            ? "bg-brand shadow-inner shadow-black/20"
