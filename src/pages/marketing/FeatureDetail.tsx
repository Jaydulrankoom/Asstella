...
const featuresData: Record<string, any> = {
  "asset-register": {
    ...
    longDesc:
      "Asstella's Asset Register provides a high-fidelity digital twin of your entire physical ecosystem. From the moment an asset is onboarded to its eventual retirement, every interaction is logged with military-grade precision.",
    highlights: [
  ...
  depreciation: {
    ...
    longDesc:
      "Eliminate the friction between operations and finance. Asstella's fiscal engine automates complex depreciation calculations, ensuring your balance sheet is always accurate and tax-ready.",
    highlights: [
  ...
  audit: {
    ...
    longDesc:
      "Physical audits shouldn't be a nightmare. Our compliance hub orchestrates high-speed verification workflows that are transparent, verifiable, and completely paperless.",
    highlights: [
    ...
    image:
      "https://images.unsplash.com/photo-1454165833767-027ff3302bc5?auto=format&fit=crop&q=80&w=1200",
  },
  maintenance: {
    ...
    longDesc:
      "Maximize asset lifespan through intelligent preventive maintenance. Asstella tracks every service ticket, warranty period, and replacement cycle to keep your operations running at 100%.",
    highlights: [
  ...
  amc: {
    ...
    longDesc:
      "Consolidate and manage every Annual Maintenance Contract in one place. Never miss a renewal or lose sight of what your service providers are committed to deliver.",
    highlights: [
  ...
  gps: {
    ...
    longDesc:
      "Asstella extends its asset tracking capabilities into the mobile world. Monitor your fleet's location, health, and utilization in real-time within a unified dashboard.",
    highlights: [
    ...
    image:
      "https://images.unsplash.com/photo-1559251646-cd60161bc8df?auto=format&fit=crop&q=80&w=1200",
  },
  healthcare: {
    ...
    longDesc:
      "From surgical robots to mobile ventilators, Asstella ensures life-critical hardware is tracked, sterilized, and maintained to the highest regulatory standards.",
    highlights: [
  ...
  manufacturing: {
    ...
    longDesc:
      "Maximize OEE (Overall Equipment Effectiveness) by unifying your production line assets into a single intelligence layer. Monitor uptime, maintenance, and lifecycle value.",
    highlights: [
  ...
  education: {
    ...
    longDesc:
      "Universities are small cities. Asstella tracks everything from laboratory mass spectrometers to classroom furniture across hundreds of buildings and thousands of users.",
    highlights: [
    ...
    image:
      "https://images.unsplash.com/photo-1523050335192-ce11558cd97d?auto=format&fit=crop&q=80&w=1200",
  },
  docs: {
    ...
    longDesc:
      "Build upon the Asstella platform and connect it with your entire IT ecosystem. Our RESTful API offers endpoints covering the full lifecycle of your enterprise assets.",
    highlights: [
  ...
  webinars: {
    ...
    longDesc:
      "Join the Asstella leadership and prominent supply-chain professionals to deep dive into the modern era of Fixed Asset Management, depreciation, and AI-driven planning.",
    highlights: [
  ...
  careers: {
    ...
    longDesc:
      "At Asstella, we are always searching for top-tier engineers, designers, and operation experts who want to build critical, high-impact systems that run the real, physical world.",
    highlights: [
      ...
      <div className="max-w-7xl mx-auto space-y-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="inline-flex items-center gap-3 px-3 py-1 bg-brand/10 border border-brand/20 rounded-full text-[10px] font-black text-brand uppercase tracking-[0.2em]">
              <data.icon className="w-3 h-3" /> Technical Module:{" "}
              {id?.toUpperCase()}
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-20">
          <div className="lg:col-span-2 space-y-12">
            <h3 className="text-sm font-black text-brand uppercase tracking-[0.4em]">
              Core Capability
            </h3>
            ...
            <ul className="space-y-6">
              {data.highlights.map((h: string) => (
                <li key={h} className="flex gap-4">
                  ...
                  <span className="text-sm font-medium text-slate-600 dark:text-slate-400 leading-relaxed uppercase tracking-tighter">
                    {h}
                  </span>
                </li>
              ))}
        ...
        <div className="bg-brand p-20 rounded-[4rem] text-center space-y-10 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-8">
            <h3 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter">
              Ready to professionalize <br /> your {data.title}?
            </h3>
            <Link
              to="/contact"
              className="inline-block px-12 py-6 bg-white text-brand font-black rounded-2xl shadow-2xl hover:scale-105 transition-all uppercase tracking-widest text-sm"
            >
