      ...
      <div className="max-w-7xl mx-auto space-y-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <p className="text-slate-600 dark:text-slate-400 font-medium text-lg leading-relaxed">
              Founded in 2020, Asstella was born from a simple realization:
              while software assets were evolving at light speed, physical asset
              management was stuck in the era of spreadsheets and manual logs.
            </p>
            <p className="text-slate-500 font-medium leading-relaxed">
              We built a platform that treats a laptop, a truck, or a skyscraper
              with the same digital sophistication as a cloud server. Our
              mission is to provide every enterprise with an absolute, real-time
              map of their physical world.
            </p>
          </div>
        ...
        <div className="space-y-16 py-20 border-t border-slate-100 dark:border-white/5">
          <div className="text-center space-y-4">
            <h2 className="text-sm font-black text-brand uppercase tracking-[0.4em]">
              Our Leadership
            </h2>
...
function ValueCard({ icon: Icon, title, desc }: any) {
  return (
    <div className="p-10 bg-slate-50 dark:bg-white/5 rounded-[2.5rem] border border-slate-100 dark:border-white/5">
      ...
      <h4 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight mb-3">
        {title}
      </h4>
