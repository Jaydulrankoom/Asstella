  ...
  const featureGroups = [
    {
      ...
      features: [
        {
          icon: Database,
          name: "Centralized Asset Hub",
          desc: "Consolidate every asset into a single, high-performance database with custom attributes.",
        },
        {
          icon: ScanLine,
          name: "QR/Barcode Ecosystem",
          desc: "Generate and manage unique identifiers for instant hardware-to-cloud mapping.",
        },
        {
          icon: Search,
          name: "Semantic Global Search",
          desc: "Find anything across your enterprise instantly with intelligent filter logic.",
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          desc: "Automate service tickets, track repairs, and manage preventive schedules.",
        },
        {
          icon: FileText,
          name: "Contract & AMC Guard",
          desc: "Never miss a renewal with intelligent tracking for service level agreements.",
        },
        {
          icon: Truck,
          name: "Supply Chain & Multi-Vendor",
          desc: "Directly manage vendor relationships and procurement flows within the platform.",
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          desc: "Real-time dashboards providing deep insights into asset health and fiscal utilization.",
        },
        {
          icon: ShieldCheck,
          name: "Audit Integrity",
          desc: "Blockchain-inspired immutable logs for every asset interaction and state change.",
        },
        {
          icon: Users,
          name: "Stakeholder Portals",
          desc: "Granular access for auditors, finance leads, and department managers.",
        },
      ],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto space-y-32">
        ...
        <div className="max-w-3xl space-y-6">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-slate-900 dark:text-white uppercase tracking-tighter leading-[0.9]">
            The toolset of the <br /> <span className="text-brand">modern</span>{" "}
            auditor.
          </h1>
          <p className="text-slate-500 font-medium text-lg max-w-xl">
            We've stripped away the complexity of traditional ERPs to give you a
            focused, high-speed interface for physical operations.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              ...
              <p className="text-slate-500 font-medium leading-relaxed">
                Our proprietary scanning engine is optimized for low-light
                industrial environments. No special hardware required—just the
                device in your pocket.
              </p>
              <ul className="space-y-4">
                {[
                  "0.2s identification speed",
                  "Offline buffering and sync",
                  "Batch processing support",
                  "AI-assisted thermal detection",
                ].map((item) => (
                  <li
                    key={item}
                    className="flex items-center gap-3 text-xs font-black uppercase tracking-widest text-slate-900 dark:text-white"
                  >
