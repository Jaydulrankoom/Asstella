      ...
      <div className="max-w-7xl mx-auto space-y-24">
        ...
        <div className="max-w-3xl space-y-6">
          ...
          <p className="text-slate-500 font-medium text-lg max-w-xl">
            Our enterprise consulting team is ready to help you architect an
            unbeatable asset strategy.
          </p>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      required
                      type="text"
                      className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl px-5 py-4 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-brand transition-all"
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <ContactItem
                  icon={Mail}
                  label="Email Hub"
                  value="sales@asstella.com"
                />
                <ContactItem
                  icon={Phone}
                  label="Global Line"
                  value="+1 (555) 000-ASST"
                />
                <ContactItem
                  icon={MapPin}
                  label="Headquarters"
                  value="700 Market St, San Francisco, CA"
                />
              </div>
            </div>
            ...
            <div className="p-8 bg-brand/10 border border-brand/20 rounded-[2rem] flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-1">
                  Available for Business & Enterprise Customers
                </p>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="flex gap-6 items-start group">
      ...
      <div className="pt-1">
        ...
        <p className="font-bold text-slate-900 dark:text-white uppercase tracking-tighter">
          {value}
        </p>
      </div>
    </div>
