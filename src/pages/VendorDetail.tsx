      ...
      <div className="h-full flex flex-col items-center justify-center text-center p-8 space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-500 max-w-md mx-auto mt-2 uppercase text-[10px] font-bold tracking-widest leading-loose">
            The vendor ID identifier ({id}) does not exist in the active
            procurement ecosystem or has been archived.
          </p>
        </div>
        <button
      ...
      <div className="bg-card-bg border border-border-dim rounded-3xl sm:rounded-[3rem] p-6 sm:p-12 shadow-2xl relative overflow-hidden flex flex-col md:flex-row gap-12 items-center md:items-start text-center md:text-left transition-colors duration-300">
        ...
        <div className="flex-1 space-y-6 relative z-10">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl sm:text-4xl font-black text-slate-900 dark:text-white uppercase tracking-tighter leading-none">
                {vendor.name}
              </h1>
            ...
            <div className="flex flex-col items-center md:items-end">
              <div className="flex items-center gap-1.5 text-amber-500 mb-1">
                ...
                <span className="ml-2 text-lg font-black text-slate-900 dark:text-white">
                  {vendor.rating}
                </span>
              </div>
              <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">
                Global Partner Rating
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-12 gap-8">
          ...
          <div className="bg-card-bg border border-border-dim rounded-2xl sm:rounded-[2.5rem] p-6 sm:p-10 shadow-sm">
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center justify-between p-6 bg-app-bg border border-border-dim rounded-2xl hover:bg-slate-50 dark:hover:bg-white/5 transition-all group/item cursor-default"
                >
        ...
        <div className="col-span-12 lg:col-span-4 space-y-8">
          <div className="bg-slate-900 text-white rounded-2xl sm:rounded-[2.5rem] p-6 sm:p-10 shadow-2xl relative overflow-hidden group">
            ...
            <h4 className="text-[10px] font-black text-brand uppercase tracking-widest mb-2">
            ...
            <p className="text-slate-400 text-xs font-bold uppercase tracking-widest leading-relaxed mb-10 opacity-70">
              Total capital processed through this vendor across all fiscal
          ...
          <div className="bg-card-bg border border-border-dim rounded-2xl sm:rounded-[2.5rem] p-6 sm:p-8 shadow-sm">
            ...
            <div className="space-y-3">
              <ExternalLinkItem
                ...
                value="www.globaltech.com"
              />
              <ExternalLinkItem
                label="Support Portal"
                value="support.globaltech.com"
              />
              <ExternalLinkItem
                label="Public Catalog"
                value="view-catalog.gt"
              />
            </div>
          </div>
        </div>
  ...
  return (
    <div className="flex items-start gap-4 group cursor-default">
      ...
      <div>
        ...
        <p className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-tight truncate max-w-[150px]">
          {value}
        </p>
      </div>
    </div>
...
function PerformanceMetric({ label, value, icon: Icon, color }: any) {
  return (
    <div className="flex flex-col items-center text-center gap-3">
      <div
        className={cn(
          "w-14 h-14 rounded-2xl flex items-center justify-center bg-app-bg border border-border-dim shadow-inner",
          color,
        )}
      >
