...
export default function Profile() {
  ...
  return (
    <div
      className="max-w-5xl mx-auto space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-bottom-5 duration-700 p-2 sm:p-0"
      id="profile_page"
    >
      {/* Header Card */}
          ...
          <div className="flex gap-2 w-full md:w-auto">
            ...
            >
              {isSaving ? (
                ...
                <>
                  <CheckCircle2 className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> Updated
                </>
              ) : (
                <>
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Update your account password. Ensure it contains at least 8
                    characters.
                  </p>
                </div>
            ...
            {activeTab === "social" && (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Connect your professional platforms for better enterprise
                    collaboration.
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  <InputField
                    ...
                    onChange={(v) =>
                      setProfile({
                        ...profile,
                        socials: { ...profile.socials, linkedin: v },
                      })
                    }
                    icon={Linkedin}
                  />
                  <InputField
                    ...
                    onChange={(v) =>
                      setProfile({
                        ...profile,
                        socials: { ...profile.socials, twitter: v },
                      })
                    }
                    icon={Twitter}
                  />
                  <InputField
                    ...
                    onChange={(v) =>
                      setProfile({
                        ...profile,
                        socials: { ...profile.socials, facebook: v },
                      })
                    }
                    icon={Facebook}
                  />
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-brand/10 border border-brand/20 p-6 rounded-2xl sm:rounded-3xl space-y-4 shadow-sm">
            ...
            <ul className="space-y-4">
              <PermissionNode
                icon={CheckCircle2}
                label="Direct Asset Acquisition"
              />
              <PermissionNode
                icon={CheckCircle2}
                label="Financial Journal Approval"
              />
              <PermissionNode
                icon={CheckCircle2}
                label="System-wide Audit Control"
              />
              <PermissionNode
                icon={CheckCircle2}
