...
const initialContracts: Contract[] = [
  {
    ...
    coverage:
      "Hardware replacement & on-site support for all Latitude laptops.",
    contactPerson: "Michael Scott",
    phone: "+1 (555) 012-3456",
  },
  {
    id: "AMC-2024-05",
    vendor: "APC Power Care",
    assetCount: 12,
    value: "$ 2,200/yr",
    status: "Expiring Soon",
    expiryDate: "15 June 2024",
    coverage: "Quarterly battery health checks and UPS firmware updates.",
    contactPerson: "Jim Halpert",
    phone: "+1 (555) 987-6543",
  },
  {
    id: "AMC-2023-11",
    vendor: "Elevator Solutions Co.",
    assetCount: 4,
    value: "$ 8,400/yr",
    status: "Expired",
    expiryDate: "01 May 2024",
    coverage: "Monthly safety inspection and emergency rescue system testing.",
    contactPerson: "Pam Beesly",
    phone: "+1 (555) 456-7890",
  },
  {
    id: "AMC-2024-09",
    vendor: "Honeywell Fire & Safety",
    assetCount: 120,
    value: "$ 5,500/yr",
    status: "Active",
    expiryDate: "20 Oct 2024",
    coverage:
      "Annual smoke detector calibration and sprinkler system auditing.",
  ...
  },
  {
    ...
    coverage:
      "High-voltage switchgear maintenance and thermal imaging reports.",
  ...
  },
  {
    ...
    coverage:
      "Core network backbone maintenance and priority software updates.",
    contactPerson: "Oscar Martinez",
  ...
  },
  {
    ...
    value: "$ 4,300/yr",
    status: "Expiring Soon",
    expiryDate: "22 May 2024",
    coverage: "Printer fleet managed services and toner supply automation.",
    contactPerson: "Kevin Malone",
    ...
    setContracts((prev) =>
      prev.map((c) => {
        if (c.id === contractId) {
          ...
          const newExpiry = c.expiryDate.replace(
      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm">
            Manage annual maintenance and service agreements
          </p>
        </div>
        <button
      ...
      <div className="bg-card-bg border border-border-dim rounded-2xl shadow-xl overflow-hidden">
        <div className="p-4 sm:p-6 border-b border-border-dim flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 bg-slate-50/50 dark:bg-white/5">
          ...
          <div className="relative w-full xl:w-80">
            ...
            <input
              type="text"
              placeholder="Search contracts by vendor or ID..."
              className="w-full bg-app-bg border border-border-dim rounded-xl pl-9 pr-4 py-3 text-xs outline-none focus:ring-2 focus:ring-brand/20 transition-all font-medium"
            />
          </div>
        </div>
          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-border-dim">
              {contracts.map((contract) => (
                ...
                >
                  <td className="px-6 py-5 font-bold text-brand font-mono text-[11px]">
                    {contract.id}
                  </td>
            ...
            >
              ...
              <div>
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">
                  {contract.assetCount} Assets Covered
                </p>
              </div>
          ...
          <CreateContractModal
            ...
            onSave={(c: any) => {
              setContracts((prev) => [
                {
                  ...c,
                  id: `AMC-2024-${Math.floor(Math.random() * 90) + 10}`,
                  status: "Active",
                },
                ...prev,
              ]);
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-app-bg border border-border-dim w-full max-w-xl rounded-none sm:rounded-3xl overflow-hidden shadow-2xl relative h-full sm:h-auto overflow-y-auto"
      >
            ...
            >
              ...
              <div className="p-6 sm:p-8 space-y-6 sm:space-y-8">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  <div>
                    <label className="text-[9px] sm:text-[10px] font-black text-slate-500 uppercase tracking-widest block mb-1">
                      Service Provider
                    </label>
                    <div className="text-lg sm:text-xl font-black text-slate-900 dark:text-white uppercase">
                      {contract.vendor}
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white">
                        {contract.assetCount} Specific Units Covered
                      </div>
                    </div>
                    <div>
                      <label className="text-[9px] sm:text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">
...
function MetricCard({ label, value, icon: Icon, color }: any) {
  ...
  return (
    <div className="bg-card-bg border border-border-dim p-4 sm:p-5 rounded-xl sm:rounded-2xl shadow-sm">
      <div
        className={cn(
          "w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4",
          colorStyles[color],
        )}
      >
      ...
      <div className="text-lg sm:text-xl font-black text-slate-900 dark:text-white mt-1 uppercase">
        {value}
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={{ scale: 1, opacity: 1 }}
        exit={{ scale: 0.9, opacity: 0 }}
        className="bg-app-bg border border-border-dim w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden"
      >
        ...
        <div className="p-8 space-y-4">
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full bg-card-bg border border-border-dim p-3 rounded-xl text-sm"
              placeholder="e.g. Oracle Support"
            />
          </div>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    assetCount: parseInt(e.target.value),
                  })
                }
                className="w-full bg-card-bg border border-border-dim p-3 rounded-xl text-sm"
              />
          ...
          <button
            ...
            className="w-full py-4 bg-brand text-white font-black rounded-2xl mt-6 uppercase tracking-widest shadow-lg shadow-brand/20"
          >
            SAVE AMC CONTRACT
          </button>
        </div>
