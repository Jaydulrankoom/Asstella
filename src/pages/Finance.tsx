    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm">
            Asset valuation, depreciation journals, and fiscal health
          </p>
        </div>
        <button
          className={cn(
      ...
      <AnimatePresence>
        {showSuccess && (
          ...
          >
            <CheckCircle className="w-5 h-5" /> Depreciation run completed
            successfully for May 2024! Journal entries posted.
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-card-bg border border-border-dim rounded-2xl p-6 shadow-xl h-[300px] sm:h-[400px] flex flex-col">
          <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-6">
            Asset Valuation Trend (Millions)
          </h3>
        ...
        <div className="bg-brand/10 border border-brand/20 p-6 rounded-2xl flex flex-col justify-between">
          <div>
            <div className="text-[10px] font-black text-brand uppercase tracking-widest mb-4">
              Summary FY24
            </div>
      ...
      <div className="bg-card-bg border border-border-dim rounded-2xl overflow-hidden shadow-xl">
        <div className="p-6 border-b border-border-dim">
          <h3 className="text-sm font-bold uppercase tracking-widest text-slate-500 text-center lg:text-left">
        ...
        <div className="divide-y divide-border-dim overflow-x-auto">
          {[
            {
              id: "J-9920",
              desc: "Monthly Depreciation - IT Equipment",
              amount: "$ 14,250",
              date: "31 May 2024",
              status: "Posted",
              breakdown: "Server Farm: $8k, workstations: $6.25k",
            },
            {
              id: "J-9919",
              desc: "Asset Acquisition - V-239 Vehicle",
              amount: "$ 32,000",
              date: "28 May 2024",
              status: "Posted",
              breakdown: "Delivery Van purchase for Logistics department",
            },
            {
              id: "J-9918",
              desc: "Monthly Depreciation - Office Devices",
              amount: "$ 2,100",
              date: "31 May 2024",
              status: "Posted",
              breakdown: "Printers and copiers across regional branches",
            },
            {
              id: "J-9917",
              desc: "Disposal Loss - Machinery A-102",
              amount: "$ 4,500",
              date: "25 May 2024",
              status: "Posted",
              breakdown: "Write-off for non-operational unit at Warehouse 1",
            },
          ].map((j) => (
            <div
              key={j.id}
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <span className="text-sm font-bold text-slate-900 dark:text-white truncate max-w-[200px] sm:max-w-none">
                    {j.desc}
                  </span>
              ...
              <div className="flex items-center gap-4 sm:gap-8 shrink-0">
                ...
                <button className="p-2 text-slate-300 group-hover:text-brand transition-colors">
      ...
      <AnimatePresence>
        {showReport && (
          <AuditorReportModal onClose={() => setShowReport(false)} />
        )}
        {selectedJournal && (
          <JournalDetailModal
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-app-bg border border-border-dim w-full max-w-2xl rounded-3xl overflow-hidden shadow-2xl"
      >
        ...
        <div className="p-8 space-y-8">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[9px] font-black bg-emerald-500 text-white px-2 py-0.5 rounded">
                UNQUALIFIED
              </span>
            </div>
            <div className="p-5 bg-card-bg border border-border-dim rounded-2xl text-sm font-medium italic text-slate-600 dark:text-slate-400 leading-relaxed shadow-inner">
              "We have physically verified 99.8% of high-value assets. The
              depreciation methods applied are consistent with international
              accounting standards. No material discrepancies were found in the
          ...
          <div className="flex gap-4">
            ...
            <button
              onClick={onClose}
              className="flex-1 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-black rounded-2xl uppercase tracking-widest shadow-xl active:scale-95 transition-all"
            >
              Close Report
            </button>
          </div>
  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={{ scale: 1, opacity: 1 }}
        exit={{ scale: 0.9, opacity: 0 }}
        className="bg-app-bg border border-border-dim w-full max-w-lg rounded-3xl overflow-hidden shadow-2xl"
      >
        <div className="p-8 space-y-6">
          ...
          <button
            onClick={onClose}
            className="w-full py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-black rounded-2xl uppercase tracking-widest shadow-xl active:scale-95 transition-all"
          >
            GO BACK
          </button>
        </div>
