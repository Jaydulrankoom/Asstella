              ...
              <div key={user.id} className="bg-app-bg border border-border-dim rounded-2xl p-5 space-y-4 hover:border-brand/40 transition-all">
                ...
                <div className="flex items-center justify-end gap-3 pt-2">
                   <button 
                      ...
                      className="flex-1 py-3 bg-white dark:bg-white/5 border border-border-dim rounded-xl text-[10px] font-black uppercase tracking-widest text-brand"
                   >
                      Manage
                   </button>
                   <button 
                      onClick={() => handleDelete(user.id)}
                      className="p-3 bg-white dark:bg-white/5 border border-border-dim rounded-xl text-rose-500"
                   >
